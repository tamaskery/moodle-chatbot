...
$string['diagnosticsexplanation'] = 'This incident tool is not a standing conversation log. A manager may open consent for one hour, each participant must opt in separately for each turn, and every capture is automatically deleted under the site retention limit. Only users with Course AI Guide management permission can view these records.';
$string['diagnosticsheading'] = 'Course AI Guide incident diagnostics';
...
$string['error:sitecircuitbreaker'] = 'The AI guide has reached the site-wide daily safety limit. It will become available again after {$a}.';
...
$string['notification:sitecircuitbreaker_body'] = 'Course AI Guide automatically paused external AI requests after reaching the configured site-wide limit of {$a->limit} logical provider calls. It resets at {$a->reset}. Review the Course AI Guide settings and provider usage before raising the limit.';
$string['notification:sitecircuitbreaker_short'] = 'Course AI Guide has paused external AI requests for today.';
$string['notification:sitecircuitbreaker_subject'] = 'Course AI Guide provider safety limit reached';
