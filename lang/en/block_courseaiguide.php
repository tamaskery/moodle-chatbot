...
$string['connectiontestback'] = 'Back to settings';
$string['connectiontestfailed'] = 'Connection failed (safe diagnostic: {$a}). No prompt or response was stored.';
$string['connectiontestheading'] = 'Test AI provider connection';
$string['connectiontestintro'] = 'This sends one fixed synthetic request using the saved endpoint, model and API key. It contains no course or participant data, counts toward the site-wide daily limit, and is not stored by the plugin.';
$string['connectiontestrun'] = 'Run connection test';
$string['connectiontestsuccess'] = 'Connection succeeded. Host: {$a->host}; model: {$a->model}; latency: {$a->latencyms} ms; request ID: {$a->requestid}. No prompt or response was stored.';
$string['connectiontestunexpected'] = 'The connection test could not be completed safely. No prompt or response was stored.';
...
$string['settings:testconnection'] = 'Provider connection test';
$string['settings:testconnection_desc'] = 'Save any setting changes first. The test sends one fixed synthetic request, consumes one call from the site-wide daily limit, and stores no prompt or response.';
$string['settings:testconnectionbutton'] = 'Test saved connection';
