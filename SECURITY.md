...
Security fixes are provided for the latest published Course AI Guide release. The current `0.2.0-beta1` release is a review candidate and should be used only in controlled deployments until its release gates pass.
